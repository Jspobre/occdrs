                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <button type="button" class="btn btn-space btn-secondary" data-toggle="modal" data-target="#myModal">
                                                                        Notify
                                                                    </button>
                                                    </div>
                                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Oas Community College Request System</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
            <form action="email-notification.php" method="POST">
                <div class="modal-body">
                    <!-- Display fetched email address in a field -->
                    <div class="form-group">
                        <label for="emailField">Email Address:</label>
                        <input type="email" class="form-control" id="emailField" name="email" value="<?=$emailAddress?>" disabled>
                    </div>
